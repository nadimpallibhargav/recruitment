...
import { Button, Form, Radio, Modal, Checkbox, Input } from "antd";
    ...
    <>
      ...
      <Modal
        ...
        footer={[
          <Button
            key="back"
            className={[HrRoundStyles.ModalFooterBtn, "greenBtnOutline"].join(
              " "
            )}
          ...
          >
            ...
            >
              ...
              >
                ...
                <InputComponent type="text" placeholder="Type here" />
              </div>
            </div>
          </Form>
        </div>
...
export default CandidateDetailsMap;
