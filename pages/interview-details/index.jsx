              ...
              <div className={styles.HrDetailsContent}>
                <div className={styles.HrDetailsStatus}>
                  <div className={styles.PreviousInterviewStatus}>
                    ...
                    <Button
                      className={["greenBtnOutline", styles.EvaluationBtn].join(
                        " "
                      )}
                    >
                      <FileTextOutlined />
                          ...
                          scheduled: (
                            <>
                              <Tooltip title="Schedule Date">
                                {selectedDate === "" ? (
                                  <DatePicker
                                    className={HrroundStyles.HrRoundDatePicker}
                                    showTime
                                    bordered={false}
                                    allowClear={false}
                                    format={dateFormat}
                                  ...
                                  <>
                                    <DatePicker
                                      className={styles.InterviewDatePicker}
                                      showTime
                                      bordered={false}
                                      defaultValue={dayjs(
                                        "23 Feb 2023 | 2:20 AM",
                ...
                >
                  ...
                  <div
                    className={[styles.HrDetailsProfessionalDetails].join(" ")}
                  >
